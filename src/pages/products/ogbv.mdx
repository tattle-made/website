...
**This is a joint project by the [Centre for Internet and Society](https://cis-india.org/) and Tattle Civic Tech. In the first year of its development, it was funded by [Omidyar Network India](https://www.omidyarnetwork.in/) as part of their Digital Society Challenge grant.**

** The tool that emerged out of this project, is called Uli, and has its own microsite. To download the tool and learn more about it please go to Uli's [website](https://uli.tattle.co.in). **

Box width={'100%'} height={'fit-content'}>
  <Image alignSelf={'start'} fill={true} fit="contain" src={"[/products/OGBV_stakeholders_2.png](https://github.com/tattle-made/OGBV/blob/main/uli-website/static/Uli_Logo.png)"} />
</Box> 
...
<Box width={'100%'} height={'fit-content'}>
  <Image alignSelf={'start'} fill={true} fit="contain" src={"/products/OGBV_stakeholders_2.png"} />
</Box> 
...
<Box width={'100%'} height={'fit-content'}>
  <Image alignSelf={'start'} fill={true} fit="contain" src={"/products/OGBV_Plugin_Features.png"} />
</Box>
