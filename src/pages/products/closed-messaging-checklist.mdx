...
This is an evolving check-list of design decisions that must consider **before** beginning any data collection from chat apps. The design choices in setting up the data collection process from closed messaging apps can be broken down into five main stages.  For a more detailed background and description of these steps, please see the paper: *[Ethical Approaches to Closed Messaging Messaging Research- Considerations in Democratic Contexts](https://): 

1. [Signing Up on the App](#signing-up-on-the-app) 
  > *  To which entity is the phone number registered?
  > *  Under what name should researchers sign up on the app?

2. [Discovering Relevant Groups](#discovering-relevant-groups) 
  > *  How are chat groups discovered and selected for research?

3. [After Joining a Group](#after-joining-a-group)
  > *  How, if at all, should researchers disclose their presence?
  > *  When should researchers decide to leave the group?

4. [Collating Data from the app](#collating-data-from-the-app)
