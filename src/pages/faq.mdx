...
Tattle is an open source project whose primary goal is to create common resources for research and response to misinformation.vThrough 2019 - 2020 a 100K USD grant from the [AI Ethics Initiative](https://aiethicsinitiative.org/news/2019/3/12/announcing-the-winners-of-the-ai-and-the-news-open-challenge) supported our work.

We also take up paid contracts for supporting researchers and organizations for analyzing data or customizing the open source tools for their applications. Our goal is to cover 60% of the project operating costs through paid contracts. We aim for a steady revenue stream to support the long term sustainability of the project. The infrastructure costs increase with volume of archived data and sophistication of search and analysis features and a steady revenue stream will ensure that we can continually maintain the resources built.
