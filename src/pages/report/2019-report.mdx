...
<Text color={'#E76D67'}> Tattle is building open tools and datasets for increasing the reach of accurate information to mobile first audiences, and for enabling greater understanding of information trends on chat apps and social media. </Text>
...
![Annual Report Cover](../../images/expenditures-2018-2019-chart.png)
