...
- Dataset of Posts from Indian Social Network : We wrote scrapers to archive social media posts from an Indian social network. Through an 8 month period spanning the pandemic in India, we gathered over a TB of videos and images. The scraper and data have been taken down temporarily due to aforementioned legal issue.
