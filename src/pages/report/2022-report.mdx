...
A statistic repeated on the Internet (without a source) is that 50% of startups fail by year 5. We don't think of Tattle as a start-up- there is no unyielding chase for growth, be it of profits or of users. As we have emphasized in the past, for us the process or the 'how' of building is as, if not more important as what we're building. Four feels like quite a ripe young age. We've managed uncertainty and weathered some storms. On the whole, we have a better sense of our capabilities and limitations. Year four was rather exciting- one in which the wisdom of our capabilities translated into execution of multiple projects. In 2022, we were working with four projects:

**Uli:**
Uli started in 2021 in collaboration with Centre for Internet and Society through a grant from the Digital Society Challenge. 2022 was the year to deliver the first beta.
...
## Uli Related:
* Arora, A., Arora, C., & J, M. (2023). Designing for Disagreements: A Machine Learning Tool to Detect Online Gender-based Violence. In Feminist Perspectives on Social Media Governance. IT for Change. https://itforchange.net/feminist-perspectives-on-social-media-governance-0
...
* Kapoor, H., Rezaei, S., Gurjar, S., Tagat, A., D., Budhwar, Y., & Puthillam, A. (2022, November 22). Does Incentivization Promote Sharing “True” Content Online?. https://doi.org/10.31234/osf.io/nykxz
...
- Contract services such as legal and accounting
  ...
  <img
    src="../../images/expenditures-2022-2023-chart.png"
    alt="expenditures"
    width="500"
  />
