...
const DataworksGameCalculator = () => {
  ...
  return (
    ...
    >
      ...
      <Form onSubmit={calculate} className="flex flex-col w-full">
    ...
    <DefaultLayout>
      ...
      >
        ...
        <Text size="small" margin={{ bottom: "medium" }}>
          ...
          done by data annotators. It has been reported that data annotators are
          often underpaid and exploited. There have been several discussions and
          attempts to understand how data workers must be compensated, and their
          work valued. This game is an attempt to think through and explore how
          we may arrive at answers to these critical questions by placing
          players in the shoes of data vendors who must ensure completion of
          tasks with limited resources. It flips the present dynamic between a
          vendor and annotators to one where it's the data vendors who must
          convince annotators to come onboard under the terms they have set out.
          Players are therefore pushed to compute and create a compensation
          model under real-world constraints in a ‘fair’ manner, and/or propose
          creative alternatives to supplant the model.
        </Text>

        <Heading level={3}>Game Play</Heading>

        <Box border={"all"} className=" w-fit md:w-1/2 flex self-center">
          <StaticImage
        ...
        <Text size="small">
          <b>Goal:</b> A group of players take on the persona of a Data Vendor
          and are given a task. There are some constraints on budget and the
          number of days in which you have to give the data back to the Data
          Client. Your job is to make a pitch to data annotators describing
          their wage and other benefits.
        </Text>

        <Heading level={3}>Set Up</Heading>
        <Text size="small">
          Each player is sorted into a group of 4-5 people (doesn’t have to be
          fixed, you can have more or less). They represent
          organizations/entities which are seeking out qualified data annotators
          to engage in annotation tasks for training their AI-assisted service
          offerings. Each group must make a pitch to the audience (who represent
          the data annotators) as to why they should work with each org/entity.
          The groups are limited by the cards they draw, i.e., money for each
          product, and the time period to complete the project.
        </Text>
        ...
        <Text size="small">
          <ul>
            <li>
              Each group draws a card which provides them a scenario, budget,
              and dataset size, some with additional conditions.
            </li>
            <li>
              The information on the card drawn by each group is immutable. It
              forms the baseline for the activity.
            </li>
            <li>
              The group must then prepare a pitch to up to 40 annotators (can be
              imaginary/think of the other people in the room as the annotators)
        ...
        <Text size="small" margin={{ bottom: "medium" }}>
          If you are playing offline, and have one disinterested friend who is
          better off as a timekeeper/referee, have them generate the scenarios
          on their phone and allot it to each of you. If you are a game nerd,
          you can also keep some color markers and chart paper handy so each
          group can get creative with their pitches. If you are playing online,
          set up a meeting on a platform that allows you to break out into
          groups, and have a timer handy.
        </Text>
