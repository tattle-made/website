      ...
      <Box className={"report"} direction={"row-responsive"}>
        ...
        <Box width={"720px"}>
          ...
          <p>
            ...
            medical resources are concise units of information that don’t rely
            on or trigger cultural, social or political beliefs. People had
            strong incentives to seek out accurate information. Despite
            deliberate reasoning, the truth status of such information was not
            easy to discern. How platforms could have best intervened to reduce
            the circulation of such content is also unclear.{" "}
          </p>
          <p>
          ...
          <p>
            ...
            be done. The analysis presented here should be treated as indication
          ...
          <p>
            ...
            <p>
              ...
              with the modality. We thus compared the textual content in the
              images with that of text messages. The word clouds of words in
              text messages and images hint that while the words used are common
              across text messages and images, they vary in their relative
              frequency. Words such as ‘hospital’, ‘patient’, ‘available’ are
              common to both text messages and images. But words such as ‘help’,
              ‘need’, ‘contact’, which are amongst the five most frequently used
            ...
            <p>
              ...
              common in text messages. This preliminary analysis suggests that
            ...
            <p>
              ...
              Furthermore, we discovered that text messages were missing for a
              few days of the first week. We thus discarded content from the
            ...
            <p>
              ...
              frequencies in text messages showed that words such as
              ‘hospitals’, ‘patient’, ‘oxygen’, ‘blood’ were prominent in text
              messages. Even in the list of 30 most frequently used, the
              frequency of usage of these terms is significantly higher than the
              frequency of other terms on the list.{" "}
            </p>
            <p>
              While recognizing that these words were important in the text
              messages during the 7 weeks, we wanted to capture the unique
              themes in a conversation in any week. For that, we used a
              technique called Term Frequency - Inverse Document Frequency
              (TF-IDF) which gives prominence to words in a week that are more
              salient compared to terms in other 6 weeks (please see Methodology
              section for more details). Words such as ‘hospital’ and ‘oxygen’
              may still feature in a specific week, which would imply that their
              usage in that week was notably higher than the other weeks.{" "}
            </p>
            <p>
              Analyzing the most frequent words (adjusted for popularity across
              weeks) we see that the word ‘oxygen’ stops appearing in the
              frequent words list after 20th May 2021. The prominence of the
              words ‘hospital’ and ‘plasma’ also decline over the 7 weeks.
              Instead, we see words associated with hyperlinks like ‘https’,
              ‘com’ become more prominent. In the last week in particular, it
              seems that WhatsApp chat links were the prominent theme.
              Unexpectedly, we also see words such as ‘CA’, ‘income’ and ‘tax‘
              feature in the last two weeks.{" "}
            </p>
            <p>
              ...
              links on chartered accountancy related webinars were shared on
              this group even in the last week of May. Towards late June,
              information about webinars on lung recovery and other health
              related topics was still shared on these groups, but its
              proportion relative to information about chartered accountancy
              declined.{" "}
            </p>
            <h2 id="key-takeaways">Key Takeaways</h2>
            <p>
              We summarize here the key takeaways from this analysis. Please
              read the full report for a more detailed discussion.{" "}
            </p>
            ...
            <p>
              The analysis shows that in a state of crisis people willingly
              shared not only personally identifiable data but also sensitive
              personal data with a group of strangers. There were tangible harms
              from identification of people from the information shared in
              relief work. Enabling messages to disappear after a certain
              duration can minimize the duration for which an individual’s
              personal information is available to ill-intentioned actors on
              these groups. Admins might also consider deleting the groups
              altogether, if the group is no longer serving the purpose it was
              created for. In many of the groups, the frequency of conversation
              declined towards the end of the analysis period. In some cases,
              participants started posting information unrelated to the
              pandemic. Destruction of data is the final step in data life cycle
              management and one that WhatApp group admins could heed more
              carefully.
            </p>
            ...
            <p>
              ...
              analysis indicated that despite the low user base, relief work,
              even on WhatsApp, relied heavily on Twitter. It appears that
              WhatsApp was the primary channel to collect requests for aid, but
              when it came to advertising availability of resources, people also
              sought information on Twitter and Instagram. These platforms could
              emerge as centralized, constantly updating repositories of
              information in a way that WhatsApp could not. This analysis
              reveals an important role for the ‘go-betweens’ who connect
              WhatsApp users to information on Twitter and Instagram, giving
              content on these platforms greater reach than that reflected by
              the engagement metrics on the platforms.{" "}
            </p>
            ...
            <p>
              ...
              trusted were needed. In the groups we were tracking, we saw
              several messages being ‘signed’ with a time stamp and/or
              information about the originator of the information. While sharing
              the lead, people added a line about who had verified it and when
              the message was last verified. Since these credibility markers are
              user created, they can be spoofed. Scamsters could just as easily
              add such a line to their messages. But within a group, where a
              baseline level of trust between members can be assumed, the
              additional information is useful context. While recent regulatory,
              academic and media attention has focused on technical mechanisms
              for suppressing misinformation on chat apps these examples reveal
              social practices for information quality management, which also
            ...
            <p>
              ...
              (less than 10\%) overlap not only with a database of verified
              leads, but also with a crowdsourced database of scam phone
              ...
              All of this (mis)information could cause immediate harm and
              demanded localized verification efforts. But it also demonstrated
              the need for coordination of these efforts. Multiple verification
              calls distracted genuine aid providers from their work of
              attending to urgent needs. The implications of crowd-sourced
              verification work during the second wave also bear on more
              professional fact-checking work. Coordination across fact-checking
              groups has been attempted around planned events such as elections
              in Mexico, Brazil and India. Can similar coordination be attempted
              around sudden and unexpected events such as the second wave in
              India?
            </p>
            ...
            <p>
              ...
              to inauthentic behaviour. Despite deliberate reasoning, the ‘truth
              status’ of medical leads was not easy to discern. On the supply
              side, the information was hyperlocal, not created or propagated in
              coordination and high in volume. Identifying inaccurate
              information was difficult, as was reducing its circulation. This
              phenomenon observed in India during the second wave of Covid-19 in
              India, is one that could occur in any location or situation where
              the need for reliable actionable information is high but trusted
              and expected information channels fail. This could be in
              subsequent waves of the pandemic, natural disasters, cyberattacks
              or wars. In such contexts, the harm from disinformation is
              immediate and tangible. Accounting for these less frequent, but
              extreme situations can strengthen our conceptions and agendas for
            ...
            <p>
              ...
              for WhatsApp group links shared on Twitter. Several of these
              groups had already reached the 256 limit, and we were thus unable
              to join them. Two groups had the ‘disappearing messages’ setting
              turned on. We took this to be an indication of intention to keep
              the communication on the group private and thus exited the groups
              ...
              this analysis to an 8-week period from 29th April 2021 to 23rd
              June 2021. From preliminary analysis, we realized that two groups
              in the first batch of groups we had joined (on 29th April 2021),
              were not Covid-19 relief groups but were run by media
              organizations to exclusively share content from their
              organization. We exited these groups and excluded them from the
              analysis. Thus, the final data that we analyzed came from a total
              of 21 groups, 16 of which we joined on 29th April 2021 and 5 of
              which we joined on 9th June.
            </p>
            <p>
              We used two parallel approaches to move data from the mobile
              device to a cloud service through which data could be analyzed. We
              used WhatsApp’s export chat feature to frequently back up the
              history of a chat on the cloud service Since WhatsApp&#39;s export
              chat feature fails to export media items reliably we resorted to
              ...
              the media items to download them. We then backed up the media
              items download folder to a secure cloud service. Since we were
              using one phone exclusively for the purpose of data collection
              from the Covid-19 relief groups, the media items in the media
              downloads folder from this duration came only from these groups.{" "}
            </p>
            ...
            <p>
              ...
              joining groups (on 9th June 2021), we did scan through the
              original groups we had joined, on the mobile phone, to understand
              which ones to exit.
            </p>
            <p>
              All personal details in images used in this report and
              visualizations were obfuscated after the analysis. For images used
              in this report, we manually blacked out phone numbers and
              personally identifiable details. For images used in the
              visualizations, we followed four steps for obfuscation: we blurred
              the images; resized them; used a machine learning algorithm to
              detect faces and conceal them with black boxes; and finally,
              manually scanned all the images and concealed phone numbers and
              other personal information still visible after the first three
              steps. The Appendix contains more details on the technical aspects
              of anonymization.{" "}
            </p>
            <p>
            ...
            <p>
              ...
              discovered, please email us at tarunima@tattle.co.in. We will act
              on it immediately.{" "}
            </p>
            ...
            <p>
              ...
              To be able to group images based on visual and semantic
              similarity, we use vector embeddings. Each image is represented as
              a 512-dimensional vector embedding. These are extracted from the
              image using a pretrained ResNet model. These vector
              ...
              cluster closely. We hoped to provide a broad label that would help
              readers understand the dataset better and encourage exploration of
          ...
          <p>
            Between 29th April 2021, when we joined the first sixteen groups,
            and 24th June 2021, when we stopped the data collection, we
            collected over 14,000 text messages. We retrospectively realized
            that messages for some days for the first week were missing. We thus
            discarded text messages from the first week, resulting in 13,524
            textual messages spanning seven weeks starting 6th May 2021 and
            ending on 24th June 2021. There was no method to identify which
            images were shared in the first week. Thus, we included all images
            in the media downloads folder in this analysis.{" "}
          </p>
          <p>
            ...
            export a media item from a chat. Since it occurs multiple times in
            any file, it gets caught in word frequency analysis but does not
            provide any insights about the data itself.
          </p>
          <p>
            <em>Word Clouds</em>
            To generate word clouds, we used the WordCloud Python library that
            tokenizes the sentence and removes stop words, but does not
            lemmatize the tokens.{" "}
          </p>
          <p>
            <em>Comparing Word Frequencies of Images and Text</em>
            To compare word frequencies of images and text, we calculate the
            proportion of occurrence of words in images and text messages. We
            then pull out the top 30 most frequent terms (measured by proportion
          ...
          <p>
            ...
            other documents in a collection. Terms with high TF-IDF scores are
            the terms in a document that are distinctively frequent in a
            document, when that document is compared other documents. In our
            analysis, the text messages in each week comprise a document,
            resulting in seven documents. TF-IDF, then finds the words that are
            salient in a particular week.{" "}
          </p>
          <p>
