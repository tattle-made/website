...
const Index = () => {
  ...
  return (
    <DefaultLayout>
      ...
      <Box width={"1020px"} alignSelf={"center"}>
        <Box direction={"row-responsive"}>
          ...
          <Box width={"100%"}>
            ...
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
              From April to June 2021, India was ravaged by the second wave of
              the Covid-19 pandemic. With a steep increase in the number of
              infections, cities ran out of drugs, medical oxygen, hospitals and
              other necessary medical supplies. The second wave also ravaged
              rural India that had weaker public health infrastructure than
              urban India.{" "}
            </Paragraph>
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
              The second wave was a public health crisis, but also an
              information crisis. As cities ran out of medical aid, people
              turned to social media to request for resources outside their
              geographies and immediate networks. The circulation of leads for
              medical aid led to a concomitant increase in circulation of
              inaccurate leads. Fraudulent leads—of scamsters duping people of
              money in promise of medical supplies—were mixed in the pool of
              information leads on social media platforms. In addition, the
              status of medical leads changed rapidly—any available hospital
              beds or drugs were taken up within minutes of being available.
              Obsolete and fraudulent leads resulted in loss of critical time in
              medical care, money and ultimately lives. Moreover, phone numbers
              of individuals from marginalized identities, circulated for
              requesting or providing aid, were used for targeted harassment.
            </Paragraph>
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
              The crisis thus resulted in spontaneous volunteering—individuals
              and groups played the role of intermediaries, connecting those in
              need to verified leads for medical aid. WhatsApp, the most widely
              used social media platform in India, emerged as a natural choice
              to organize volunteering energies. WhatsApp could be used to
              source requests for help, coordinate with other volunteers and
              connect people to adequate aid. But how was WhatsApp used to
              surface actionable information and push back on inaccurate leads
              when the platform eludes centralized takedowns and moderation? How
              did individuals filter credible leads from a glut of information
              leads?
            </Paragraph>
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
            ...
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
              We present preliminary analysis from 8 weeks of conversations in
              21 Covid-19 relief WhatsApp groups that were operational during
              the second wave of the crisis, to shed light on the information
              chaos that ensued during that period. We use vector embedding
              based machine learning to aggregate images based on visual and
              semantic similarity, and language processing techniques to make
              sense of the multi-lingual content shared on these groups. Our
            ...
            <ul style={{ padding: "0 0 0 1.2em" }}>
              <li>
                <Paragraph size={"large"}>
                  ...
                  platforms such as Twitter and Instagram to find verified
                  leads. Screenshots of posts from these platforms were commonly
                  used method to cross-post information. Twitter has fewer than
                  20 million users in India. People act as ‘go-betweens’ and
                  connect WhatsApp users to information on Twitter and
                  Instagram, giving content on these platforms greater reach.{" "}
                </Paragraph>
              </li>
              <li>
                <Paragraph size={"large"}>
                  ...
                  information (including the Biometric ID Aadhar) in these
                  groups when requesting for help. Private information was
                  circulated in groups of unknown persons who had come together
                  for public oriented service. Public and private boundaries are
                  more blurred in emergencies which demands greater attention to
                  data deletion protocols by group admins.{" "}
                </Paragraph>
              </li>
              <li>
                <Paragraph size={"large"}>
                  The frequency of conversations declined in these groups over
                  time. Some groups were repurposed to share information
                  unrelated to Covid-19 such as chartered accountancy related
            ...
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
              ...
              sprung about during the second wave of the pandemic, we posit that
              the spontaneous increase in hyperlocal information demanded
            ...
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
              ...
              political beliefs. People had strong incentives to seek out
              accurate information. Despite deliberate reasoning, the truth
              status of such information was not easy to discern. How platforms
              could have best intervened to reduce the circulation of such
              content is also unclear.{" "}
            </Paragraph>
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
            ...
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
              ...
              in English, Hindi and Marathi, since these were the languages
              understood by the team members. In addition, we also joined one
              group in Telugu. In the final sample of posts, we also found
              messages in Tamil, Telugu and Gujarati.{" "}
            </Paragraph>
            <Box>
              <Table>
                <TableBody>
            ...
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
              We relied primarily on automated techniques for broad insights
              about the content on the platforms. These techniques allowed for
            ...
            <Paragraph responsive={true} size={"large"} textAlign={"justify"}>
              ...
              medicines, concentrators, medical prescriptions, receipts and
              other paper documentation. The images seem to parallel the demand
              (gaps) observed. For example, there are a number of images of the
              drug Amphotericin, the drug used in treatment of Mucormycosis
              (Black Fungus). Our data collection period coincided with the rise
              of Mucormycosis tied to Covid-19 treatment. The multiple instances
              of images of Amphotericin and concentrators indicate an interest
              in availing or correcting information about these specific medical
              resources.{" "}
            </Paragraph>
            <TrendHeading
              head={"Trend 3"}
            ...
            <TrendHeading
              head={"Trend 4"}
              subhead={
                "Low Overlap with Database(s) of Verified Leads and Scams"
              }
            />
            <Paragraph responsive={true} size={"large"} color={"accent-3"}>
              ...
              WhatsApp groups to a database of Covid-19 Helpline numbers
              verified by FactChecker.in, the oldest fact-checking group in
              India<ExternalLink href={"#footnote_3"}>³</ExternalLink>. The
              ...
              <Paragraph responsive={true} size={"large"} color={"accent-3"}>
                ...
                numbers from the CoViD Scam Directory were shared in the
                WhatsApp groups as warnings. The remaining 14 were shared as
                genuine leads in the WhatsApp groups. Since the CoViD Scam
                Directory is crowdsourced, all numbers listed in the directory
                can&#39;t be assumed to be scam. It is however notable that even
                in this database the overlap of numbers is low—less than 6% of
                the leads shared in the 21 WhatsApp groups were captured in the
                CoViD Scam Directory.
              </Paragraph>
            </Paragraph>
            <TrendHeading
              head="Trend 5"
            ...
            <Box direction={"row"} wrap={true} gap={"medium"}>
              <Box width={"12em"}>
                <Paragraph size={"small"}>
                  <strong>
                    Public and Private Boundaries Are More Blurred in
                    Emergencies.{" "}
                  </strong>
                  In a state of crisis people willingly shared sensitive
                  personal data with a group of strangers. Enabling messages to
                  disappear after a certain duration can minimize access of such
                  data to ill-intentioned actors on these groups. Admins might
                  also consider deleting the groups altogether, if the group is
                  no longer serving the purpose it was created for. Destruction
                  of data is the final step in data life cycle management and
                  one that WhatApp group admins could heed more carefully.
                </Paragraph>
              </Box>
              <Box width={"12em"}>
                <Paragraph size={"small"}>
                  ...
                  requests for aid, but when it came to advertising availability
                  of resources, people also sought information on Twitter and
                  Instagram. This analysis reveals an important role for the
                  ‘go-betweens’ who connect WhatsApp users to information on
                  Twitter and Instagram, giving content on these platforms
                  greater reach than that reflected by the engagement metrics on
                  the platforms.
                </Paragraph>
              </Box>
              <Box width={"12em"}>
                <Paragraph size={"small"}>
                  ...
                  trusted were needed. We saw several messages being ‘signed’
                  with a time stamp and/or information about the originator of
                  the information. Since these credibility markers can be
                  spoofed, Social practices for information quality management
                  in closed messaging apps deserve more attention.
                </Paragraph>
              </Box>
              <Box width={"12em"}>
                <Paragraph size={"small"}>
                  ...
                  The phone numbers shared in the Covid-19 relief groups, had
                  low (less than 10%) overlap with an external database of
                  verified leads, as well as with a crowdsourced database of
                  scam phone numbers— the majority of numbers shared in this
                  small sample of 21 groups could not be or had not been
                  verified. The second wave of the pandemic in India resulted in
                  an unprecedented situation that challenged the process of
                  verification. It resulted in spontaneous generation of
                  hyperlocal information across India, simultaneously. This
                  demanded localized verification efforts, but also demonstrated
                  the need for coordination of these efforts.
                </Paragraph>
              </Box>
              <Box width={"12em"}>
                <Paragraph size={"small"}>
                  <strong>A New Facet of The Information Disorder. </strong>
                  The relief work during the second wave resulted in a new
                  typology of (mis)information that eludes emerging conceptions
                  of misinformation response that rely on enhancing human
                  reasoning for misinformation resilience or suppressing content
                  on platforms tied to inauthentic behaviour. This phenomenon
                  could repeat in any situation where the need for reliable
                  actionable information is high but trusted and expected
                  information channels fail such as natural disasters,
                  cyberattacks or wars. Accounting for these less frequent, but
                  extreme situations can strengthen our conceptions and agendas
                  for misinformation response.
                </Paragraph>
              </Box>
            </Box>

            {/* <Box height={"12em"} border={"all"} width={"fit-content"}>
            <Image
              src="/covid-whatsapp-public-groups/report_images/credibility_2.png"
              alt={"images of whatsapp messages with phone numbers blurred"}
              fit={"contain"}
              alignSelf={"start"}
            />
          </Box> */}
            ...
            <ul style={{ listStyleType: "none", padding: "0" }}>
              ...
              <li>
                <Paragraph
                  ...
                  margin={{ top: "none" }}
                >
                  ⁵ Silge J., Robinson D., Section 1.5. Text Mining with R: A
                  Tidy Approach. O Reilly. 2017.
                  <ExternalLink
