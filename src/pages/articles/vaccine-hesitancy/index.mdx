...
- If we look at the bigger dataset of fact checks that referenced vaccines, we find three by FactChecker.in in 2017:
  - [https://www.factchecker.in/jaitley-says-tb-elimination-by-2025-target-would-need-95-reduction-in-new-cases/](https://www.factchecker.in/jaitley-says-tb-elimination-by-2025-target-would-need-95-reduction-in-new-cases/)
  - [https://www.factchecker.in/health-ministers-claim-that-india-reduced-infant-maternal-deaths-faster-than-other-countries-false/](https://www.factchecker.in/health-ministers-claim-that-india-reduced-infant-maternal-deaths-faster-than-other-countries-false/)
  - [https://www.factchecker.in/health-ministers-claim-that-india-reduced-infant-maternal-deaths-faster-than-other-countries-false/](https://www.factchecker.in/health-ministers-claim-that-india-reduced-infant-maternal-deaths-faster-than-other-countries-false/)
- There is some pro-vaccine related misinformation as well. One such claim about lungs of a vaccinated content was checked by Factly: [This CT Scan report does not represent the lungs of a...](https://factly.in/this-ct-scan-report-does-not-represent-the-lungs-of-a-covid-19-vaccinated-person/)
...
## How Not to Interpret this Analysis
...
The dashboard is built on the headlines of fact checked stories. This is based on our experience that the headlines capture the most important aspects of a claim and are better candidates than text bodies itself. A themes dashboard built on headlines efficiently fulfills the primary aim of understanding broad misinformation trends. This methodology, however can result in some posts being left out of analysis. For example, this post
