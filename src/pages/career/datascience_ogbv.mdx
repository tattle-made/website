## Short Term Role- Data Scientist (Content Moderation)
...
Tattle Civic Tech along with the Centre for Internet and Society are building a free-to-use user-facing web plugin to help social media users in India to moderate instances of online violence in Indian languages with a focus on the experience of persons situated at the margins of gender, caste, religion and sexuality.  The project aims to move beyond the kill-switch of content take-downs and find ways to empower users to act on violent content they see online.
...
- Testing and deploying machine learning models for detection of online gender based violence (OGBV) in three Indian languages.
