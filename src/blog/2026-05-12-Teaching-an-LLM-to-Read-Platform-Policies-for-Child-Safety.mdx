---
name: Teaching an LLM to Read Platform Policies for Child Safety
...
How does RATI actually work? Say a 14-year-old's intimate image is being shared non-consensually online, a situation that is far more common than it should be. RATI's response is end-to-end.
...
It is a thorough, human-centred process. But one step inside it has a serious bottleneck.
