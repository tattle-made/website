...
excerpt: A primer on Uli's Hover Feature
author: "Denny George"
project: Uli
date: 2025-02-03
tags: online-harms
cover: ../images/uli-slur-redaction-image.jpg
---

import { Heading } from "grommet";

<Heading level={3}> Building Uli: How the hover-for-metadata feature came about.</Heading>
...
<div className="mt-4">![](../images/uli-slur-redaction.gif)</div>
...
<div className="mt-4">![](../images/hover-feature.gif)</div>
