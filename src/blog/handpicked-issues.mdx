...
date: 2024-07-17
tags: announcement
cover: cover-handpicked-issues.jpg
---
...
<img src="/banner-handpicked-issues.jpg" alt="Banner Image" />
...
|   |                                                                       |                                                                                                                               |                                 |
| - | -------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| <img src="/handpicked-issues/ic_orange.png" alt="Icon" height="80px" width="90px" />  | Create a benchmark dataset for Audio Deepfakes                             | [tattle-made/feluda#365](https://github.com/tattle-made/feluda/issues/365 "Create a benchmark dataset of Audio Deepfakes")                     | Web Scraping, ML, REST API, Datasets, Annotation |
| <img src="/handpicked-issues/ic_banana.png" alt="Icon" height="80px" width="90px" />  | Retrieve portions of non consensual sexual imagery in a video              | [tattle-made/feluda#365](https://github.com/tattle-made/feluda/issues/364 "Retrieve portions containing non consensual sexual imagery in a video")                     | Computer Vision, ML, Annotation                           |
| <img src="/handpicked-issues/ic_strawberry.png" alt="Icon" height="80px" width="90px" />  | Repair Instaloader to scrape posts on Instagram by hashtag \`#web-scraping | [instaloader/instaloader#2206](https://github.com/instaloader/instaloader/issues/2206 "hastag.get_posts() doesn't seem to be working anymore") | Web Scraping, Reverse Engineering APIs        |
...
<img src="/handpicked-issues/footer_aside.png" alt="aside" width="45%" />
