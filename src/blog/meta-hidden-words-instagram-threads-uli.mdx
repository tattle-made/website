...
At some point, Meta made it really easy to import and share your slur lists(which they call hidden words). This makes it very easy to add independent project like Uli to interface with Meta's platforms. We maintain quite possibly the largest crowdsourced [slur list in Indian Languages](https://github.com/tattle-made/Uli/blob/e2e317727803e214e170169b8506285410d6b37f/browser-extension/plugin/scripts/slur-list.txt#L4). We created a webpage for Meta users to select the Indian languages that concern them and modiy our slur list before pastinng them to your meta hidden word list.
