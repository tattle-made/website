---
title: Establishing Conventions for UI engineering with React
date: 2019-11-11
project: ""
author: Denny George
tags: Experiments
...
![](/content/images/2019/11/example-screen-1.png)
...
![](/content/images/2019/11/section-and-app-shell-3.png)App Shell and Sections (with a few example labels)
### App Shell
...
## Molecules
![](/content/images/2019/11/molecules-1.png)
...
![](/content/images/2019/11/single-media-gif.gif)demonstration of molecule-single-post going through a few states - default, loading, data
## Atoms
![](/content/images/2019/11/atoms-1.png)
...
![](/content/images/2019/11/search-example.gif)screen capture of user searching for 'flower' in our portal
...
![](/content/images/2019/11/search-example-one-fail.gif)
