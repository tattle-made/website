...
![View page source: HTML rendered on server](https://tattle-media.s3.amazonaws.com/view_page_source_ex.png)![Page Source HTML: Identify the relevant tags to scrape](https://tattle-media.s3.amazonaws.com/html_page_source_ex.png)
